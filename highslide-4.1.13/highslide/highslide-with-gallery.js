...
if (!hs) {
  var hs = {
    ...
    lang: {
      ...
      fullExpandTitle: "Расширить до фактического размера (f)",
      creditsText: "",
      ...
      restoreTitle:
        "Щелкните, чтобы закрыть изображение, нажмите и перетащите для перемещения.",
    },
      ...
      var d = document,
        ...
        iebody =
          d.compatMode && d.compatMode != "BackCompat"
            ...
            : d.body,
        ieLt9 =
          hs.ie && (hs.uaVersion < 9 || typeof pageXOffset == "undefined");
    ...
    wrapperMouseHandler: function (e) {
      try {
        ...
        if (!e.target) e.target = e.srcElement; // ie
        if (!e.relatedTarget)
          e.relatedTarget = over ? e.fromElement : e.toElement; // ie
